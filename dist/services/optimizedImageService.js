...
exports.optimizedImageService = void 0;
...
class OptimizedImageService {
     ...
     */
    async uploadBase64(base64Data, filename, metadata) {
        if (!this.bucket) {
     ...
     */
    getChunkedDownloadStream(fileId) {
        if (!this.bucket) {
            throw new Error("GridFS bucket not initialized");
        }
     ...
     */
    async downloadAsBase64Batched(fileId, maxBatchSize = 1024 * 1024 // 1MB batches
    ) {
        if (!this.bucket) {
            throw new Error("GridFS bucket not initialized");
        }
...
// Export singleton
exports.optimizedImageService = new OptimizedImageService();
