...
exports.getOTPStoreSize = getOTPStoreSize;
exports.sendOTPViaFast2SMS = sendOTPViaFast2SMS;
 ...
 */
async function sendOTPViaFast2SMS(phone, otp, appHash) {
    ...
    try {
        ...
        // Make API request
        const response = await axios_1.default.get(`https://www.fast2sms.com/dev/bulkV2?${payload.toString()}`, {
            headers: {
