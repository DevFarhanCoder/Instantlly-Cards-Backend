...
router.post('/answer', auth_1.requireAuth, async (req, res) => {
    try {
        const userId = req.userId;
...
router.post('/save-progress', auth_1.requireAuth, async (req, res) => {
    try {
        const userId = req.userId;
        const user = await User_1.default.findById(userId);
        if (!user) {
...
router.post('/reset', auth_1.requireAuth, async (req, res) => {
    try {
        const userId = req.userId;
        const user = await User_1.default.findById(userId);
        if (!user) {
...
router.post('/sync-transactions', auth_1.requireAuth, async (req, res) => {
    try {
        const userId = req.userId;
        const user = await User_1.default.findById(userId);
        if (!user) {
...
router.post('/fix-completion', auth_1.requireAuth, async (req, res) => {
    try {
        const userId = req.userId;
        const user = await User_1.default.findById(userId);
        if (!user) {
...
router.get('/debug-stats', auth_1.requireAuth, async (req, res) => {
    try {
        const userId = req.userId;
        const user = await User_1.default.findById(userId);
        if (!user) {
