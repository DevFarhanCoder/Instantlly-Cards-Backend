...
const BusinessPromotionSchema = new mongoose_1.Schema({
    userId: {
...
exports.default = mongoose_1.models.BusinessPromotion || (0, mongoose_1.model)("BusinessPromotion", BusinessPromotionSchema);
