...
const PromotionOrderSchema = new mongoose_1.Schema({
    userId: {
...
exports.default = mongoose_1.models.PromotionOrder || (0, mongoose_1.model)("PromotionOrder", PromotionOrderSchema);
